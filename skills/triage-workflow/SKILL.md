...
These are canonical role names — the actual label strings used in the issue tracker may differ. If a mapping hasn't been provided, ask the maintainer for the label names used in their tracker before labelling anything.
