...
description: "Deep research phase before building a new agent skill — parallel Exa + Tavily searches, official GitHub repos (MCP servers, existing skills, API docs), and raw SKILL.md/reference files organized into /tmp/<name>-research/. Use when building a new skill and you need prior art, API coverage, and official implementations pulled first. Triggers: research for skill, gather references, find prior art."
---
