---
name: minimax-xlsx
description: "Excel/spreadsheet operations (.xlsx, .xlsm, .csv, .tsv). Create, read, analyze, edit, validate with zero format loss. Use when user works with spreadsheets, financial models, pivot tables, formulas, or tabular data in Excel format."
license: MIT
metadata:
  version: "1.0"
