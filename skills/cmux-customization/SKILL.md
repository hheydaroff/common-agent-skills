...
- Workspace metadata: use the cmux CLI or the cmux skill's workspace reference for workspace names, descriptions, colors, read state, and sidebar metadata updates.
