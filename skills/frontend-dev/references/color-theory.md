...
> Adapted from [HermeticOrmus/design-mastery-claude-code](https://github.com/HermeticOrmus/design-mastery-claude-code) (MIT). Complements frontend-dev's color rules (max 1 accent, no AI purple/blue, no pure black).
