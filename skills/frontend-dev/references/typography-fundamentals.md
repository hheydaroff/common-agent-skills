...
> Adapted from [HermeticOrmus/design-mastery-claude-code](https://github.com/HermeticOrmus/design-mastery-claude-code) (MIT). Where this file and frontend-dev's SKILL.md disagree, SKILL.md wins.
...
Body: Geist (humanist text)  **[adapted: Inter → Geist, Inter is banned in frontend-dev]**
...
| Outfit + Geist **[adapted: Inter → Geist]** | Modern | SaaS, tech products |
...
| Inter | **[adapted]** Overused AI default; frontend-dev bans it — use Geist/Outfit/Satoshi |
...
```html
<!-- Preload critical fonts (example uses Geist; Inter is banned in frontend-dev **[adapted]**) -->
