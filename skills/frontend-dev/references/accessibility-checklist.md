...
Quick reference for WCAG 2.1 AA compliance. Accessibility is not optional — it's a quality gate.
...
| Custom dropdown with no ARIA | Unusable by keyboard/screen reader | Use native `<select>` or ARIA listbox |
